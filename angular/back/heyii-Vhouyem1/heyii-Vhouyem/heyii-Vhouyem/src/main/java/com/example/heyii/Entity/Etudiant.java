...
public class Etudiant extends User {
    ...
    public Etudiant(String nom, String prenom, String email, String motDePasse, String login, String telephone, Long cin, String dateNaissance, int niveau, GrpClass grpClass) {
