...
class Matiere {
  ...
  static Matiere defaultInstance() {
    return Matiere(
        idMatiere: '', nom: '', semestre: 1, niveau: 1);
  }
}
...
class Emploi {
  ...
  factory Emploi.fromJson(Map<String, dynamic> json) {
    return Emploi(
      ...
      groupeClasse: json['groupeClasse'] != null
          ? GrpClass.fromJson(json['groupeClasse'] as Map<String, dynamic>)
          : null,
      cours: json['cours'] != null
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'enseignants': enseignants.map((e) => e.toJson()).toList(),
      'salles': salles.map((e) => e.toJson()).toList(),
      'grpClasses': groupeClasse?.toJson(),
      'cours': cours?.toJson(),
      'admin': admin?.toJson(),
    };
  }
...
factory Cours.fromJson(Map<String, dynamic> json) {
  if (json.isEmpty) {
    throw Exception('JSON vide pour un cours.');
  }

  return Cours(
    idCours: json['idCours']?.toString() ?? 'ID Inconnu',
